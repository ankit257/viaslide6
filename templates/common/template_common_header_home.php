...
<section id = "SignUpOverlay" class="lightbox">
    ...
    <!--div class="overlay-half overlay-social-section">
        <a href=""><img class="img-responsive"  src="images/fbconnect.png"></img></a>
    </div>
    <div class="overlay-half"-->
    <div class="form-group col-lg-12 col-xs-12 col-md-12">
            <div class="loginFormIcon">
...
<?php
  include_once(THEMEPATH. 'templates/post/template_home_slide.php');
?>
</div>
  <!--iframe class="intro-slides" src="<?php // echo DOCROOT;?>view/391/"></iframe-->
</div>
<div class="container main">
<div class="row text-center">
  <div class="h2 button xcd">Get Started</div>
</div>
<script type="text/javascript">
