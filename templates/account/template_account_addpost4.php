...
.activeContent{
  border: 0.1em dashed rgba(0,0,0,0.8);
}
article{
  z-index: 1;
}
...
.background-advanced-color-settings, .advanced-font-color-settings, .transparency-slider{
  width: 200px;
  padding: 15px;
}
.nav-hidden li{
        ...
        <li class="main-buttons-li">
          <i class="fa fa-font fa-2x faX" style="color:#7fc04c;"></i>
           ...
           <ul class="nav-hidden">
              ...
              <li>
                <div class="advanced-font-color-settings" id="changeFC" data-target="fontColor">
        ...
        <li class="main-buttons-li">
          <i class="fa fa-magic fa-2x faX"></i>
           ...
           <ul class="listItems animation-direction nav-hidden">
              ...
              <li>
                <div class="advanced-font-color-settings" id="changeTBCX" data-target="textBack">
                  <h5>Advanced Color Options</h5>
                  <div class="red"></div>
                  <div class="green"></div>
                  <div class="blue"></div>
  ...
  <div class="container-main">
    ...
    <ul class="rteControlsBar controls">
      ...
      <li style="list-style:none;">
        <form id="addPicture2" action="<?php echo DOCROOT;?>?route=account/addimage"  onsubmit="validateImage()" method="post" enctype="multipart/form-data">   
          <input class="solid-bdr" type="file" class="file" id="fileinput2" name="myfile" onchange="document.getElementById('submitPicture2Form').click();" title="Insert Picture"style="width:40px; z-index:99; opacity:0; cursor:pointer; position:absolute;"/>
    ...
    <div  class="asdf" style="display:inline-block;">
      <select  class="selectCustom" onchange="formatDoc('fontsize',this[this.selectedIndex].value);this.selectedIndex=0;editFocus();">
...
var iframesrc = "<?php echo DOCROOT.'view/'.$postdata[0]['id'].'/';?>";
...
$('.bg-transition').on('click', function(){
  var s = $(this).attr('data-effect');
  //$("#backgrounds").addClass(s);
  $("#backgrounds").attr('data-css',s);
})
...
function sendFormContent(e){
  ...
  $("#background1").css("background-size",'');
    ...
    $("#myCanvas").remove();
    if(e=='preview'){
    $('.overlay-preview').css('display', 'block');
      var x = document.createElement('iframe');
      x.setAttribute('id','preview');
      x.setAttribute('style','height:100%; width:100%;');
      x.setAttribute('src', iframesrc);
      document.getElementById('overlay-preview').appendChild(x);
    }
  },
});
