...
<div id="content">
  <div class="breadcrumb">
    ...
    <div class="box">
    <div class="heading">
      <h1><img alt="" src="view/image/product.png"> Post</h1>
    ...
    <div class="content">
      <div class="htabs" id="tabs"><a href="#tab-general" style="display: inline;" class="selected">General</a><a href="#tab-data" style="display: inline;" class="">Data</a><a href="#tab-fields" style="display: inline;" class="">Fields</a></div>
      <form id="form" enctype="multipart/form-data" method="post" action="">
        <div id="tab-general" style="display: block;">
          <div class="htabs" id="languages">
            ...
            <table class="form">
              <tbody><tr>
                <td><span class="required">*</span> Post Name:</td>
                <td><input type="text" value="<?php echo $name; ?>" size="100" name="info[name]">
        ...
        <div id="tab-fields" style="display: none;">
        	<table class="form">
              <tbody>
                ...
                <tr>
					<td><?php echo ucwords(str_replace("_", " ",$field[field])) ; ?></td>
                    <?php if ( $field[type] == "textarea" ) : ?>
                    <td><textarea rows="5" cols="40" name="field[<?php echo $field[field]; ?>]"><?php echo $field[value]; ?></textarea></td>
                    <?php else : ?>
                    <td><input type="<?php echo $field[type]; ?>" name="field[<?php echo $field[field]; ?>]" value="<?php echo $field[value]; ?>" size="100" style="margin-right: 0px; padding-right: 0px; width: 506px;" /></td>
                    <?php endif ; ?>
                </tr>
                <?php } ?>
        ...
        <tr>
            ...
            <tr>
              ...
              <?php if($categories) : $i=0; foreach($categories as $category) { ?>
              <div class="<?php echo $i % 2 == 0 ? 'even' : 'odd' ; ?>" id="product-category<?php echo $category[category_id]; ?>">
              	<?php echo $category[name]; ?>
                <img alt="" src="view/image/delete.png">
                <input type="hidden" value="<?php echo $category[category_id]; ?>" name="product_category[]">
              </div>
              <?php } $i++; endif; ?>
              </td>
        </tr>
