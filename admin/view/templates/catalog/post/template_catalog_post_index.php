  ...
  <div class="breadcrumb">
    ...
    <div class="heading">
      ...
      <div class="buttons">
          ...
          <a class="button" href="index.php?route=catalog/post/insert">Insert</a>
          <?php endif; ?>
        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left">
              	<a class="<?php echo isset($_GET[order]) ? strtolower($_GET[order]) : 'asc' ; ?>" href="index.php?route=catalog/post&sort=title&order=<?php echo isset($_GET[order]) && $_GET[order]=='DESC'  ? 'ASC' : 'DESC' ; ?>">Post Title</a>
			  </td>
			  <td class="left">Filter by Category</td>
              <td class="left">Uploader Name</td>
              <td class="left">Filter by Date</td>
          ...
          <tbody>
			...
			<tr>
              ...
              <td class="center"><img width="50" height="50" src="<?php echo $post[image]; ?>" /></td>
