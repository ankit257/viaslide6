...
<div id="content">
  <div class="breadcrumb">
        <a href="index.php?route=common/home">Home</a>
         :: <a href="index.php?route=catalog/category">Category</a>
      </div>
    ...
    <div class="box">
    <div class="heading">
      <h1><img alt="" src="view/image/category.png"> Category</h1>
      <div class="buttons"><a class="button" onclick="$('#form').submit();">Save</a><a class="button" href="index.php?route=catalog/category">Cancel</a></div>
    </div>
    <div class="content">
      <div class="htabs" id="tabs"><a href="#tab-general" style="display: inline;" class="selected">General</a><a href="#tab-data" style="display: inline;" class="">Data</a><a href="#tab-design" style="display: inline;" class="">Design</a></div>
      <form id="form" enctype="multipart/form-data" method="post" action="">
          ...
          <div class="htabs" id="languages">
            ...
            <table class="form">
              <tbody><tr>
                ...
                <td><input type="text" value="<?php echo $cat_name; ?>" size="100" name="info[name]">
        ...
        <div id="tab-data" style="display: none;">
          <table class="form">
            <tbody><tr>
              <td>Parent:</td>
              <td><input type="text" size="100" value="<?php echo $parent; ?>" name="path" class="ui-autocomplete-input" autocomplete="off" role="textbox" aria-autocomplete="list" aria-haspopup="true">
                <input type="hidden" value="<?php echo $parent; ?>" name="parent_id"></td>
            </tr>
            <tr>
              <td>Filters:<br><span class="help">(Autocomplete)</span></td>
              <td><input type="text" value="<?php echo $filter; ?>" name="filter" class="ui-autocomplete-input" autocomplete="off" role="textbox" aria-autocomplete="list" aria-haspopup="true"></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td><div class="scrollbox" id="category-filter">
                                                    </div></td>
            </tr>
            <tr>
              <td>Stores:</td>
              <td><div class="scrollbox">
                                    <div class="even">
                                        <input type="checkbox" checked="checked" value="0" name="category_store[]">
                    Default                                      </div>
                                  </div></td>
            </tr>
            <tr>
            ...
            <tr>
              <td>Top:<br><span class="help">Display in the top menu bar. Only works for the top parent categories.</span></td>
              <td>                <input type="checkbox" value="1" name="info[top]" <?php echo $top == 1 ? 'checked="checked"' : ''; ?>>
                </td>
            </tr>
            <tr>
              <td>Columns:<br><span class="help">Number of columns to use for the bottom 3 categories. Only works for the top parent categories.</span></td>
              <td><input type="text" size="1" value="<?php echo $column; ?>" name="info[column]"></td>
            </tr>
            <tr>
              <td>Sort Order:</td>
