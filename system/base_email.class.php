...
class PHPMailer {
  ...
  */
  ...
  public function createHtmlMsg($email_data) {
	...
	$body = "" ;
	  if($email_data) {
		foreach($email_data as $key=>$value) {
			...
			if( $key == "User_Name" )
				$body .= "Dear ". $value. ",<br /><br />";

			if( $key == "Top_Content" )
				$body .=  $value. "<br /><br />";
				
			if( $key == "Details_Content" ) {
				foreach($email_data[Details_Content] as $tableDataKey=>$tableDataValue) {
					$body .=  str_replace("_", " ", $tableDataKey).	" : " .$tableDataValue. "<br />";
				}
			}
			
			if( $key == "Bottom_Content" )
				$body .=  $value. "<br /><br />";
  ...
  public function createPlainMsg($data) {
	  	$str= $this->createHtmlMsg($data);
	  	$str = preg_replace("/(\r\n|\n|\r)/", "", $str);
